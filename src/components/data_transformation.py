...
import os,sys
from src.constants.train_constants import TARGET_COLUMN
...
from src.utils.all_utils import read_yaml_file,save_numpy_array_data, save_object
    ...
    def get_data_transformer_object(cls) -> Pipeline:
        ...
        try:
            ...
            preprocessor = Pipeline(
                steps=[("SimpleImputer", simple_imputer),("RobustScaler", robust_scaler)]
            )
