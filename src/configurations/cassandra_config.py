...
from src.constants.database import KEYSPACE_NAME,DATABASE_NAME
from src.constants.environments import ASTRA_CLUSTER_ID, ASTRA_REGION, ASTRA_DB_APPLICATION_TOKEN
